...
dashed.]{\includegraphics[width=0.45\textwidth,height=\textheight]{./figures/scatter.png}\label{fig:scatter}}
\subfloat[Histogram of \% Differences in Segregation
Measures]{\includegraphics[width=0.45\textwidth,height=\textheight]{./figures/diff_hist.png}\label{fig:diff_hists}}
